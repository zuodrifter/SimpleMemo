...
public class Edit extends Activity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener,
        View.OnLongClickListener, RadioGroup.OnCheckedChangeListener{

    LinearLayout myLayout;
    TextView date_text,time_text,av;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestWindowFeature(Window.FEATURE_NO_TITLE);//将系统自带的标题栏隐藏掉
